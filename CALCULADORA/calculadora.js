 ...
 let Botondos = document.getElementById("botonDos");
    Botondos.addEventListener('click',function(event){
        ...
        function calcular() {
            ...
            let n3 = parseFloat(document.getElementById("number3").value) || 0;
            ...
            if(n2>n1){
                number="El numero 2 es mayor que el numero 1"
            }
            else if(n1<n2){
                number="El numero 1 es menor que el numero 2"
        }

           
            
            alert("El resultado de " + n1 + " " + simbolo + " " + n2 + " " + simbolo + " " + n3 + " es: " + resultado + number);
        }
    JavaScript